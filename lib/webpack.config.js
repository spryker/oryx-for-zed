...
async function getConfiguration(settings) {
    ...
    let entries = configurePaths(entryPaths, settings.runtimeEntryName);
    const compatibilityEntryPath = `./${settings.paths.guiPath}/assets/Zed/js/${settings.runtimeEntryCompatibilityName}.entry.js`;
    entries[settings.runtimeEntryCompatibilityName] = compatibilityEntryPath;

    const runtimeEntryInitPath = `./${settings.paths.guiPath}/assets/Zed/js/${settings.runtimeEntryCompatibilityName}.entry.js`;
    entries[settings.runtimeEntryInit] = runtimeEntryInitPath;
